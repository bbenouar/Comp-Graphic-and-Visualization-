...
private:
	...
	GLuint shadowMap;  // OpenGL ID for the shadow map texture
	GLuint shadowMapFBO;  // Framebuffer object for shadow mapping

	void InitializeShadowMapping();  // Method to initialize shadow mapping resources
